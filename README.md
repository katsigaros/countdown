...
> Άνοιγμα αυτής της σελίδας στο [https://katsigaros.github.io/countdown/](https://katsigaros.github.io/countdown/)
...
* αναζήτηση για **https://github.com/katsigaros/countdown** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/katsigaros/countdown/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/katsigaros/countdown** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/katsigaros/countdown/raw/master/.github/makecode/blocks.png)
